...
var controller = guiData.add(data, 'hovering', 0, 3).name('Hovering over:').listen();
controller.domElement.querySelector('input').disabled = true; // Make the controller read-only
guiData.open();
